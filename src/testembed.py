...
#             if no_evolution:
#                 super().__init__(
#                     colour=Style(pokemon.pokedex_data.poke_types[DEFAULT_TYPE])[
#                         1
#                     ],
...
#         self.cache = cache
#         self.raw_evolution_tree = (
#             pokemon.evolution_tree if pokemon.evolution_tree != [] else []
#         )
...
#                             pokemon=self.find_stage(
#                                 int(stage["from"]["nationalNo"][1:])
#                             ),
#                         )
#                     )
...
#                         self.EvolutionPage(
#                             stage_number=evo_cnt,
#                             pokemon=self.find_stage(int(stage["to"]["nationalNo"][1:])),
...
#                                 pokemon=self.find_stage(
#                                     int(stage["to"]["nationalNo"][1:])
#                                 ),
#                                 requirement=stage["requirement"],
#                             )
#                         )
#                         evo_tree[str(int(stage["to"]["nationalNo"][1:]))] = (
#                             from_stage + 1
#                         )
