    ...
    class Version:
        ...
        class BaseStats:
            ...
            def __init__(self, base_stats: dict) -> None:
                ...
                self._total = self.Stat(base_stats['Total'])
    ...
    class Evolution:
        ...
        class EvolutionPokemon:
            ...
            def __init__(self, pokemon: dict) -> None:
                ...
                self._type: List[Type] = [Type(poke_type) for poke_type in pokemon['type']]
        ...
        def __init__(self, evolution) -> None:
            ...
            self._shed: self.EvolutionPokemon | None = evolution['shed'] if evolution['shed'] is None else self.EvolutionPokemon(evolution['shed'])
